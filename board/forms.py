...
class ThreadForm(forms.ModelForm):
    ...
    thread_text = forms.CharField(label=False, max_length='1500', widget=forms.Textarea(attrs={'style': 'background: #454545; color: #f9f9f9;', 'class': 'form-control', 'rows': '2.5', 'placeholder': 'Thread text'}),)
...
class CommentForm(forms.ModelForm):
    ...
    comment_text = forms.CharField(max_length=1500, widget=forms.Textarea(attrs={'style':'background: #454545; color: #f9f9f9;', 'class':'form-control', 'rows':'2.5', 'placeholder':'Start typing your comment here', }))
